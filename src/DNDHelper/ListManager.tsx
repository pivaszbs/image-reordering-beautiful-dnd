...
function ComponentWithMaxItems<T extends { id: string }>(
  props: WithMaxItemsProps<T> & Omit<Props<T>, "chunks">
) {
  const maxItems: number =
    props.maxItems && props.maxItems > 0 ? props.maxItems : props.items.length;
